...
const PcardLeft: React.FC<PcardProps> = ({ title, description, imageUrl }) => {
  return (
    <div className="flex gap-6 justify-items-center items-center mx-auto">
      ...
      <div className="hidden md:block">
        <h2 className="font-drukXXCondTrial text-[12rem] tracking-[4] leading-zero uppercase text-start">
          {title}
        </h2>
        <p className="font-medium text-xl leading-zero uppercase text-start">
          {description}
        </p>
      </div>
    </div>
